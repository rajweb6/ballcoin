...
uint256 hashGenesisBlock("0x467005a8cdd505bcd8b194411b84c1cf1622c387b4682b238c10befcf49eaede");
...
const string strMessageMagic = "BallCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // BallCoin: 1 days
static const int64 nTargetSpacing = 120; // BallCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ballcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BallCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6c87540d494886d1cdf6e9e990ec2e90fc6e915a03c8fec29c4a7d525b889971");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1503135840; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 127180;

        if (fTestNet)
        {
            block.nTime    = 1502871180;
            block.nNonce   = 928327;
        }
